...
var TableInit = function () {
    ...
    oTableInit.Init = function () {
        $('#tb_list').bootstrapTable({
            // data: [],//要加载的数据。
            url: '/Customer/CustomerList', //从远程站点请求数据的URL。     请注意，所需的服务器响应格式取决于是否'sidePagination' 指定了该选项
            ...
            theadClasses: "thead- light", //使用theadClasses选项设置表标题样式。三种模式  undefined(默认)   thead- light   thead - dark
            ...
            locale: "zh-CN",//本地语言
            uniqueId: "Cst_ID", //每一行的唯一标识，一般为主键列
            ...
            columns: [
                ...
                },
                {
                    ...
                    title: '操作',
                    formatter: function (value, row, index) {
                        var button = '<button id="btnUpdateCustomer" class="btn btn-primary" style="margin-left:5px;" onclick="UpdateCustomer(' + row.Cst_ID + ')">完善客户信息</button>';
                        return button;
                    }
                }
            ],
    ...
    oTableInit.queryParams = function (params) {
        var fromPage = {
            ...
            offset: params.offset, //当前页面及之前数据总和 
