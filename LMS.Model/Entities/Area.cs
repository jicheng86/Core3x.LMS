...
namespace LMS.Model.Entities
{
    ...
    public class Area : Entity, ICreationAudited, IModificationAudited, IActively, ISoftDelete
    {
        ...
        /// 电话区划号码 清远（0755）
        /// </summary>
        [Display(Name = "电话区划号码"), StringLength(50, ErrorMessage = "字段：{0}长度不能超过：{1}")]
        public string TelephoneCode { get; set; }
        /// <summary>
        /// 邮编 清远（513000）
        /// </summary>
        [Display(Name = "邮编"), StringLength(50, ErrorMessage = "字段：{0}长度不能超过：{1}")]
        public string ZipCode { get; set; }
        /// <summary>
        /// 行政区划全拼：清远市（qingyuanshi）
        /// </summary>
        [Required(ErrorMessage = "字段：{0}，不能为空！"), Display(Name = "行政区划全拼"), StringLength(50, ErrorMessage = "字段：{0}长度不能超过：{1}")]
        public string CompleteSpelling { get; set; }
        /// <summary>
        /// 行政区划简拼：清远市（qys）
        /// </summary>
        [Required(ErrorMessage = "字段：{0}，不能为空！"), Display(Name = "行政区划简拼"), StringLength(50, ErrorMessage = "字段：{0}长度不能超过：{1}")]
        public string LogogramSpelling { get; set; }
        /// <summary>
        /// 城市中心坐标点：清远市（113.051227,23.685022）
        /// </summary>
        [Display(Name = "城市中心坐标点"), StringLength(50, ErrorMessage = "字段：{0}长度不能超过：{1}")]
        public string Center { get; set; }
        /// <summary>
        /// 首字母：清远市（q）
        /// </summary>
        [Required(ErrorMessage = "字段：{0}，不能为空！"), Display(Name = "城市中心坐标点"), StringLength(50, ErrorMessage = "字段：{0}长度不能超过：{1}")]
        public string NameFirstChar { get; set; }
        /// <summary>
        /// 城市经度
        /// </summary>
        [Display(Name = "城市经度值"), StringLength(50, ErrorMessage = "字段：{0}长度不能超过：{1}")]
        public string Longitude { get; set; }
        /// <summary>
        /// 城市纬度值
        /// </summary>
        [Display(Name = "城市纬度值"), StringLength(50, ErrorMessage = "字段：{0}长度不能超过：{1}")]
        public string Latitude { get; set; }
        /// <summary>
        /// 数据版本号 当前版本：20190115
        /// </summary>
        [Required(ErrorMessage = "字段：{0}，不能为空！"), Display(Name = "数据版本号"), StringLength(50, ErrorMessage = "字段：{0}长度不能超过：{1}")]
