...
namespace LMS.Model
{
    public class Area : Entity, ICreationAudited, IModificationAudited, IActively, ISoftDelete
    {
        ...
        /// 行政区划Code
        /// </summary>
        [Required(ErrorMessage = "字段：{0}，不能为空！"), Display(Name = "行政区划Code"), StringLength(50, ErrorMessage = "{0}长度不能超过50{1}")]
        public string CityCode { get; set; }
        /// <summary>
        /// 父级行政区划Code
        /// </summary>
        [Required(ErrorMessage = "字段：{0}，不能为空！"), Display(Name = "父级行政区划Code"), StringLength(50, ErrorMessage = "{0}长度不能超过50{1}")]
        public string ParentCode { get; set; }
        /// <summary>
        /// 行政区划简称： XX省 或 XX市 或 XX区 或 XX街道
        /// </summary>
        [Required(ErrorMessage = "字段：{0}，不能为空！"), Display(Name = "行政区划简称"), StringLength(50, ErrorMessage = "{0}长度不能超过50{1}")]
        public string LogogramName { get; set; }
        /// <summary>
        /// 省市区全称聚合：广东省,清远市
        /// </summary>
        [Required(ErrorMessage = "字段：{0}，不能为空！"), Display(Name = "省市区全称聚合"), StringLength(100, ErrorMessage = "{0}长度不能超过100{1}")]
        public string MergerName { get; set; }
        /// <summary>
        /// 省市区简称聚合：广东,清远
        /// </summary>
        [Required(ErrorMessage = "字段：{0}，不能为空！"), Display(Name = "省市区简称聚合"), StringLength(50, ErrorMessage = "{0}长度不能超过50{1}")]
        public string MergerLogogramName { get; set; }
        /// <summary>
        /// 行政区划级别country:国家,province:省份,city:市,district:区县,street:街道
        /// </summary>
        [Required(ErrorMessage = "字段：{0}，不能为空！"), Display(Name = "行政区划级别"), StringLength(50, ErrorMessage = "{0}长度不能超过50{1}")]
        public string AreaLevel { get; set; }
        /// <summary>
        /// 级别 0.国家，1.省(直辖市) 2.市 3.区(县),4.街道
        /// </summary>
        [Required(ErrorMessage = "字段：{0}，不能为空！"), Display(Name = "行政区划级别值"), Range(0, 4, ErrorMessage = "{0}不能超出取值范围：{1}~{2}")]
        ...
        /// </summary>
        [Required(ErrorMessage = "字段：{0}，不能为空！"), Display(Name = "行政区划全拼"), StringLength(50, ErrorMessage = "{0}长度不能超过：{1}")]
        public string CompleteSpelling { get; set; }
        /// <summary>
        /// 行政区划简拼：清远市（qys）
        /// </summary>
        [Required(ErrorMessage = "字段：{0}，不能为空！"), Display(Name = "行政区划简拼"), StringLength(50, ErrorMessage = "{0}长度不能超过：{1}")]
        ...
        /// 首字母：清远市（q）
        /// </summary>
        [Required(ErrorMessage = "字段：{0}，不能为空！"), Display(Name = "城市中心坐标点"), StringLength(50, ErrorMessage = "{0}长度不能超过：{1}")]
        ...
        /// 数据版本号 当前版本：20190115
        /// </summary>
        [Required(ErrorMessage = "字段：{0}，不能为空！"), Display(Name = "数据版本号"), StringLength(50, ErrorMessage = "{0}长度不能超过：{1}")]
